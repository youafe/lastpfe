	...
	
{
	...
	//////////////////////////////////Teacher Info ////////////////////////////////
	public function teacher_login_check($t_username,$t_password)
	{ 
		$t_login_check = "select  * from teacher_info where t_username = '$t_username' and t_pass='$t_password'";
		$t_login_run = $this->connectdb->query($t_login_check);
		$t_login_num = $t_login_run->num_rows;
		return $t_login_num;
	}
	public function teacher_info_select($t_username)
	{
		$teacher_info_sel = "select * from teacher_info where t_username ='$t_username'";
		$teacher_info_run = $this->connectdb->query($teacher_info_sel);	
		return $teacher_info_run;
	}
